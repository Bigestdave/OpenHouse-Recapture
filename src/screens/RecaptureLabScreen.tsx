...
import { ArrowRight, CalendarDays, CheckCircle2, CircleAlert, Clock3, ExternalLink, FolderOpen, LoaderCircle, Mail, MapPin, MessageCircle, Plus, ShieldCheck, Sparkles } from 'lucide-react'
